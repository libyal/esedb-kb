...
class ESEDatabaseFileEntryLister(dfimagetools_file_entry_lister.FileEntryLister):
    ...
    def __init__(self, mediator=None):
        ...
        self._data_type_fabric = self._ReadDataTypeFabricDefinitionFile("format.yaml")
    ...
    def _DetermineDataFormat(self, file_object):
        ...
        data_type_map = self._GetDataTypeMap(layout_element_definition.data_type)
