...
def Main():
    ...
    argument_parser = argparse.ArgumentParser(
        description=("Extract the catalog from the ESE database file.")
    )
    ...
    if not artifact_definitions:
        artifact_definitions = os.path.join(os.path.dirname(artifacts.__file__), "data")
